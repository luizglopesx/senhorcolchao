...
- **Pré-Festa do Peão 2026** — LANÇAMENTO 20/07, roda até 09/08 (21 dias, R$600 total / ~R$28,57 dia — verba subiu de R$400 pra R$600 em 16/07, R$200 além do que estava realocado da Fase 2). Esquenta antecipando a Festa do Peão de Barretos (evento 20-30/08) — mix geral de produto com Solteiro em destaque (motivo real da demanda de agosto, ver `empresa.md`). Planejamento completo em `marketing/campanhas/pre-festa-peao-2026/planejamento-campanha.md`. **Artes em produção (16/07):** 3 peças prontas via Higgsfield (feed + story) — Colchão D28 Comfortopedic Solteiro (R$479), Cama Box SmartFlex Casal (R$1.690), Colchão Orthoplus Casal (R$1.390), com produto real do catálogo Supabase. Usuário está convertendo as peças aprovadas em vídeo (motion) antes de salvar. Pendente: agendamento (GitHub Actions Instagram, Facebook, WhatsApp Status) e definição de calendário final.
