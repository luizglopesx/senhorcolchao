...
- **Durma como Campeão — Fase 1** — ATIVA desde 06/07, encerra 19/07 (R$30/dia, otimizada pra CONVERSATIONS). **Quinzena fraca:** CTR (0,57% acumulado) segue abaixo do benchmark (0,90-1,20%). Em 16/07 pareceu ter travado (4 dias seguidos sem conversa nova, 13-16/07) — decisão foi deixar rodar sem trocar criativo (só 3 dias restantes). **Correção em 17/07: a estagnação era atraso de atribuição do Meta, não dado real** — 15/07 e 16/07 tiveram conversa sim, só apareceram fechadas um dia depois. Decisão de não trocar criativo segue válida. Lição: dado de 1-2 dias recentes no Meta Ads é provisório, evitar decisão definitiva em cima dele. Relatórios diários em `marketing/campanhas/relatorios/AAAA-MM-DD-durma-como-campeao-snapshot.md`.
...
- **Pré-Festa do Peão 2026** — LANÇAMENTO 20/07, roda até 09/08 (21 dias, R$600 total / ~R$28,57 dia — verba subiu de R$400 pra R$600 em 16/07, R$200 além do que estava realocado da Fase 2). Esquenta antecipando a Festa do Peão de Barretos (evento 20-30/08) — mix geral de produto com Solteiro em destaque (motivo real da demanda de agosto, ver `empresa.md`). Planejamento completo em `marketing/campanhas/pre-festa-peao-2026/planejamento-campanha.md`. 3 peças prontas via Higgsfield (feed + story + motion) — Colchão D28 Comfortopedic Solteiro (R$479), Cama Box SmartFlex Casal (R$1.690), Colchão Orthoplus Casal (R$1.390), com produto real do catálogo Supabase. **Status em 17/07 — tudo pronto, aguardando só ativação manual do Patrocinado:**
  ...
  - ✅ Meta Ads (Patrocinado/CTWA) **ativado manualmente pelo usuário em 20/07** (09h25, antes do lançamento orgânico das 11h): campanha `120247929494160752`, ad set `120247929500490752` (raio 40km Barretos + interesses Rodeio/Agronegócio/Móveis/Decoração/Colchão, otimizado CONVERSATIONS, R$28,57/dia), 3 anúncios ACTIVE (SmartFlex Casal, Orthoplus Casal, D28 Solteiro). Fluxo documentado na memória `meta-ads-ctwa-workflow`.
  ...
  - ✅ 3 WhatsApp Status antigos da Fase 2 cancelada (21, 23, 25/07) mantidos ativos — **checado em 17/07: preços corretos, não é desatualização.** R$1.890 é a Cama Box Orthoplus completa (não o colchão avulso R$1.390 da Pré-Festa), R$2.390 é a SmartFlex **Queen** (não a Casal R$1.690 da Pré-Festa) — produtos/tamanhos diferentes, coexistem sem conflito.
...
- **Checagens de 13 a 17/07: CPA de 14 dias em melhora constante** — R$44,13 (15/07) → R$40,03 (16/07) → **R$36,69 (17/07)**, com 10 conversões acumuladas em 14 dias. Nenhuma outra campanha da conta voltou a gastar (só CP01C ativa).
...
- Auditorias: `marketing/campanhas/relatorios/2026-06-26-google-ads-auditoria.md` → ... → `2026-07-11-google-ads-auditoria.md` (primeira conversão + correção de keyword confirmada) → **`2026-07-17-google-ads-auditoria.md`** (mais recente — CPA em queda, situação estável)
